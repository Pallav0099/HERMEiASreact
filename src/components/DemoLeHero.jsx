        ...
        <div className="relative top-[5rem] w-full lg:px-15 overflow-hidden mb-40">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 pt-10">
                <div className="flex items-center justify-center align-middle text-center max-w-7xl mx-auto space-y-1">
                    <TextGenerateEffect words={HeroText} duration={1.5} delay={0.3} className="text-5xl lg:text-6xl xl:text-7xl font-semibold text-white/90 motion-blur-in-2xl motion-opacity-in-0 motion-duration-1500" />
                </div>
                <div className="">
                    <div className="grid">
