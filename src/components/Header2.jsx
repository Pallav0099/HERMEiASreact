...
const Header2 = () => {
    ...
    return (
        <div className={`fixed top-0 left-0 w-screen z-50 border-b border-gray-700 lg:bg-black/90 lg:backdrop-blur-sm ${openNavigation ? "bg-black" : "bg-black/90 backdrop-blur-sm"}`}>
